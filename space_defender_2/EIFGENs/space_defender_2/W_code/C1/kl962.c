...
extern EIF_TYPED_VALUE F962_7226(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7227(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7228(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 961, Current, 3, 0, 13524);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ur1 = tr1;
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5018, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 961, Current, 2, 0, 13525);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F962_7226)
EIF_TYPED_VALUE F962_7226 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 961, Current, 1, 0, 13526);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13526);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	RTHOOK(2);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1555, "is_dotnet", loc1))(loc1)).it_b);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13527);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F962_7228 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 961, Current, 1, 1, 13528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTNHOOK(2,1);
	ur1 = RTCCL(arg1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2192, "item", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	loc1 = RTCCL(tr2);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
		RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
...
{
	GTCX
	RTOTS (7224,F962_7224)
	RTOTS (7225,F962_7225)
	RTOTS (7226,F962_7226)
