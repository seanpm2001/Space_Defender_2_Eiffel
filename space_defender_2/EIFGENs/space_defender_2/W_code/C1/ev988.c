...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6329, 0xF8000473, 0); /* select_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6331, 0xF8000473, 0); /* deselect_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6333, 0xF8000472, 0); /* column_title_click_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6335, 0xF8000472, 0); /* column_resized_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
