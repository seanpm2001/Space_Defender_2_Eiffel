...
static EIF_TYPED_VALUE F987_8538_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F987_8538(EIF_REFERENCE);
extern EIF_TYPED_VALUE F987_8539(EIF_REFERENCE);
static EIF_TYPED_VALUE F987_8540_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F987_8540(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6325, 0xF8000482, 0); /* select_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F987_8538_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 14882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 14882);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F987_8538 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6325, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F987_8538_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6325,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 986, Current, 1, 0, 14883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 14883);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6327, 0xF8000482, 0); /* deselect_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F987_8540_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 14884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 14884);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F987_8540 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6327,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6327, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F987_8540_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6327,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
