...
extern EIF_TYPED_VALUE F1406_13285(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1406_13285 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1405, Current, 0, 0, 19744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1405, Current, 19744);
	RTIV(Current, RTAL);
	RTHOOK(1);
