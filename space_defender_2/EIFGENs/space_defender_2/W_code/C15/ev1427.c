...
extern void F1427_13592(EIF_REFERENCE);
extern void F1427_13593(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1427_13594(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1427_13595(EIF_REFERENCE);
static EIF_TYPED_VALUE F1427_13596_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1427_13596(EIF_REFERENCE);
...
void F1427_13592 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1426, Current, 0, 0, 19982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1426, Current, 19982);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9341, 1422))(Current);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9341, 1606))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1427_13593 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1426, Current, 1, 2, 19983);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1426, Current, 19983);
	RTCC(arg1, 1426, l_feature_name, 1, RTWCT(10306, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1427_13594 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1426, Current, 2, 1, 19984);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1426, Current, 19984);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("i_within_bounds", EX_PRE);
...
EIF_TYPED_VALUE F1427_13595 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1426, Current, 0, 0, 19985);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1426, Current, 19985);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1427_13596_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1426, Current, 0, 0, 19986);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1426, Current, 19986);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1427_13596 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9346, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1427_13596_body (Current)).it_r;
