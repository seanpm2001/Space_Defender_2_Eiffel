...
extern void F1424_13570(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1424_13571_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1424_13571(EIF_REFERENCE);
...
void F1424_13570 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1423, Current, 1, 1, 19970);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		RTHOOK(3);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9941, dtype))(Current)).it_b);
		if (tb1) break;
		RTHOOK(4);
		...
		RTNHOOK(4,2);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10288, "update_for_pick_and_drop", tr2))(tr2, ub1x);
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1424_13571_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1424_13571 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9346, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1424_13571_body (Current)).it_r;
