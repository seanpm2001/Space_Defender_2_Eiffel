...
extern void F1174_10375(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1174_10376(EIF_REFERENCE);
extern void EIF_Minit1174(void);
extern EIF_REFERENCE _A1174_67();
...
/* {ETF_DUMMY}.make */
void F1174_10375 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1173, Current, 0, 3, 16940);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1174_67, (EIF_POINTER)(0),7919, 0, 0, 1, -1, tr1, 0);
	}
	tr1 = RTCCL(tr2);
	RTAR(Current, tr1);
...
/* {ETF_DUMMY}.etf_dummy */
void F1174_10376 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1173, Current, 0, 0, 16941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1173, Current, 16941);
	RTIV(Current, RTAL);
	RTHOOK(1);
