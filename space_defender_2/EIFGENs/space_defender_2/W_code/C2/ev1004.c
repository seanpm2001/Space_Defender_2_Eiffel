...
extern EIF_TYPED_VALUE F1004_8663(EIF_REFERENCE);
static EIF_TYPED_VALUE F1004_8664_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8664(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8665(EIF_REFERENCE);
static EIF_TYPED_VALUE F1004_8666_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8666(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1004_8667(EIF_REFERENCE);
static EIF_TYPED_VALUE F1004_8668_body(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1004_8663 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1003, Current, 1, 0, 15003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6451, 0xF800047E, 0); /* pointer_motion_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1004_8665 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1003, Current, 1, 0, 15005);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6453, 0xF8000481, 0); /* pointer_button_press_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1004_8666_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1004_8666 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6453, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1004_8666_body (Current)).it_r;
...
EIF_TYPED_VALUE F1004_8667 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1003, Current, 1, 0, 15007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1003, Current, 15007);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6455, 0xF8000481, 0); /* pointer_double_press_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1004_8668_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1003, Current, 0, 0, 15008);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1004_8668 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6455, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1004_8668_body (Current)).it_r;
