...
extern EIF_TYPED_VALUE F1024_8770(EIF_REFERENCE);
...
RTOID (F1024_8770)
EIF_TYPED_VALUE F1024_8770 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1023, Current, 0, 0, 15084);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1023, Current, 15084);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
