...
static EIF_TYPED_VALUE F1486_14606_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1486_14606(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1485, Current, 1, 0, 20803);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {1572,0xFF01,1318,0xFFFF};
			EIF_TYPE typres0;
...
/* {EV_ITEM_I}.interface */
static EIF_TYPED_VALUE F1486_14606_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1486_14606 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9346, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1486_14606_body (Current)).it_r;
