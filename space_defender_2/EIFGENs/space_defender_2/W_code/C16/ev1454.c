...
extern void F1454_14000(EIF_REFERENCE);
static EIF_TYPED_VALUE F1454_14004_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1454_14004(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1454_14000 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 20305);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 20305);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1454_14004_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1453, Current, 0, 0, 20306);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1453, Current, 20306);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1454_14004 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9346, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1454_14004_body (Current)).it_r;
