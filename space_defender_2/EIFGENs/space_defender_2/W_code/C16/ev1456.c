...
extern void F1456_14027(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1456_14028_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1456_14028(EIF_REFERENCE);
...
void F1456_14027 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1455, Current, 1, 1, 20312);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		RTNHOOK(4,2);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10866, "update_for_pick_and_drop", tr2))(tr2, ub1x);
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1456_14028_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1455, Current, 0, 0, 20313);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1456_14028 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9346, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1456_14028_body (Current)).it_r;
