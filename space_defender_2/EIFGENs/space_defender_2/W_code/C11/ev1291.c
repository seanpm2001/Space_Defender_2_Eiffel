...
extern EIF_TYPED_VALUE F1291_11625(EIF_REFERENCE);
extern void F1291_11626(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1291_11625 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1291_11626 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1290, Current, 0, 0, 18304);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1290, Current, 18304);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8417, 0xF8000596, 0); /* implementation */
