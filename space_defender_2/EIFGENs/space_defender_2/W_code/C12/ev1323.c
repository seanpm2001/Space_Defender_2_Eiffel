...
extern EIF_TYPED_VALUE F1323_12029(EIF_REFERENCE);
extern void F1323_12030(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1323_12029 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1323_12030 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1322, Current, 0, 0, 18709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1322, Current, 18709);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8417, 0xF80005D0, 0); /* implementation */
