...
extern void F1370_12674(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1370_12675(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1370_12681(EIF_REFERENCE);
...
void F1370_12674 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1369, Current, 0, 1, 19228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19228);
	RTCC(arg1, 1369, l_feature_name, 1, RTWCT(9346, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1370_12675 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19229);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1369, Current, 1, 0, 19230);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19230);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6459, "readable_pixbuf_formats", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
...
EIF_TYPED_VALUE F1370_12677 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19231);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19232);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19225);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5817, 970))(Current)).it_p);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1369, Current, 0, 0, 19226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19226);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F1370_12681)
EIF_TYPED_VALUE F1370_12681 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1369, Current, 1, 0, 19227);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1369, Current, 19227);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(1, 0xF800055B, 0, 0); /* loc1 */
	...
	RTHOOK(3);
	RTDBGAL(0, 0xF8000150, 0,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8231, "font_names_on_system", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2333, "linear_representation", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	Result = (EIF_REFERENCE) RTCCL(tr2);
	RTHOOK(4);
...
{
	GTCX
	RTOTS (12676,F1370_12676)
	RTOTS (12681,F1370_12681)
}
