...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6630, 0xF800047D, 0); /* pick_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6632, 0xF8000477, 0); /* pick_ended_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6634, 0xF8000482, 0); /* conforming_pick_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6636, 0xF8000471, 0); /* drop_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
