...
extern void F1096_9459(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_STR_ARG}.make */
void F1096_9459 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1095, Current, 0, 1, 15714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1095, Current, 15714);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7165, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7179, 0xF80000E8, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1095, Current, 0, 0, 15716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1095, Current, 15716);
	RTIV(Current, RTAL);
	RTHOOK(1);
