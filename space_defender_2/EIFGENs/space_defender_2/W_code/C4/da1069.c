...
extern EIF_TYPED_VALUE F1069_9327(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1069_9327 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1068, Current, 0, 0, 15584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1068, Current, 15584);
	RTIV(Current, RTAL);
	RTHOOK(1);
