...
extern EIF_TYPED_VALUE F1532_15336(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1532_15336 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1531, Current, 0, 0, 21451);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1531, Current, 21451);
	RTIV(Current, RTAL);
	RTHOOK(1);
